...
public class Bootcamp {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getNome(), bootcamp.getNome()) && Objects.equals(getDescricao(), bootcamp.getDescricao()) && Objects.equals(getDateInicial(), bootcamp.getDateInicial()) && Objects.equals(getDateFinal(), bootcamp.getDateFinal()) && Objects.equals(getDevsInscritos(), bootcamp.getDevsInscritos()) && Objects.equals(getConteudos(), bootcamp.getConteudos());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getNome(), getDescricao(), getDateInicial(), getDateFinal(), getDevsInscritos(), getConteudos());
    }
}
